...
public class FileUtil {
    ...
    public static GeneratorInfo generatorInfo;
    ...
    // 初始化util信息
    /*
     * public void setGeneratorInfo(GeneratorInfo info) { this.generatorInfo =
     * info; }
     */

    /*
     * public void getFileArray() { this.allClassFiles = new ArrayList<>();
     * this.allXmlFiles = new ArrayList<>(); this.allHtmlFiles = new
     * ArrayList<>(); }
     */
    ...
    public static void createDto(DBTable table) throws IOException {
        // key 是否需要引入相对包
    ...
    public static void createFtlInfoByType(pType type, DBTable table) throws IOException, TemplateException {
        String projectPath = generatorInfo.getProjectPath();
        String parentPackagePath = generatorInfo.getParentPackagePath();
        String packagePath = generatorInfo.getPackagePath();
    ...
    public static void createFtl(FtlInfo ftlInfo, pType type) throws IOException, TemplateException {
         ...
         * File(request.getContextPath()+ "/generator/ftl"));
         */
        if (type == pType.Controller) {
    ...
    // 获取文件夹下所有文件列表
    public static void getFileList(String basePath, String directory) {
