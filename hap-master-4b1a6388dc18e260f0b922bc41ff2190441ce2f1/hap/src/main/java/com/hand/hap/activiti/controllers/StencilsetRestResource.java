...
public class StencilsetRestResource {
    @RequestMapping(value = { "/editor/stencilset",
            "/service/editor/stencilset" }, method = RequestMethod.GET, produces = "application/javascript;charset=UTF-8")
    @ResponseBody
    public String getStencilset(HttpServletRequest request) {
        ...
        if (env.equalsIgnoreCase("en_GB") || env.equalsIgnoreCase("en_US") || env.equalsIgnoreCase("en")) {
